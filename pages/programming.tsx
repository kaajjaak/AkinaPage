            ...
            <div className={styles.bgImg}>
                <main className={`${styles.main}`}>
                    ...
                    <div className={styles.desktopBars}>
                        ...
                        <DesktopBar alt="girl in holding a book" image={image2} title="Projects:" left={true}
                    ...
                    <div className={styles.wrapper}>
                        <div className={`${styles.selectImg} ${styles.hidePhone}`}>
                            <Image src={image3} alt="girl in cafe looking at you" height="256" width="256" layout="responsive" objectFit="cover"/>
                        </div>
